...
def generate_launch_description():
    ...
    aliengo = FindPackageShare('z1_description')
    default_rviz_config_path = PathJoinSubstitution([aliengo, 'config', 'config.rviz'])
    ...
    # URDF model path within the aliengo
    ...
    xacro_file_path = PathJoinSubstitution([
        aliengo,  # Replace with your package name
        "xacro",
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([aliengo, 'rviz', LaunchConfiguration('rvizconfig')])],
